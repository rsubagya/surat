...
<body>
        ...
        <div id="sidebar-nav" class="sidebar">
            <div class="sidebar-scroll">
                <nav>
                    ...
                    <ul class="nav">
                        <li><a href="index.php" class="active"><i class="lnr lnr-home"></i> <span>Beranda</span></a>
                        </li>
 ...
 -->
		...
		$surat = mysql_query("SELECT * FROM surat_masuk WHERE tanggal_terima BETWEEN '2021-07-01' AND '2021-07-31'");
		$surat2 = mysql_query("SELECT * FROM surat_masuk WHERE tanggal_terima BETWEEN '2021-08-01' AND '2021-08-30'");
		$surat3 = mysql_query("SELECT * FROM surat_masuk WHERE tanggal_terima BETWEEN '2021-09-01' AND '2021-09-31'");
		$surat4 = mysql_query("SELECT * FROM surat_masuk WHERE tanggal_terima BETWEEN '2021-10-01' AND '2021-10-30'");
		$surat5 = mysql_query("SELECT * FROM surat_masuk WHERE tanggal_terima BETWEEN '2021-11-01' AND '2021-11-31'");
		$surat6 = mysql_query("SELECT * FROM surat_masuk WHERE tanggal_terima BETWEEN '2021-12-01' AND '2021-12-31'");

		$surat7 = mysql_query("SELECT * FROM surat_keluar WHERE tanggal_dikeluarkan BETWEEN '2021-07-01' AND '2021-07-31'");
		$surat8 = mysql_query("SELECT * FROM surat_keluar WHERE tanggal_dikeluarkan BETWEEN '2021-08-01' AND '2021-08-30'");
		$surat9 = mysql_query("SELECT * FROM surat_keluar WHERE tanggal_dikeluarkan BETWEEN '2021-09-01' AND '2021-09-31'");
		$surat10 = mysql_query("SELECT * FROM surat_keluar WHERE tanggal_dikeluarkan BETWEEN '2021-10-01' AND '2021-10-30'");
		$surat11 = mysql_query("SELECT * FROM surat_keluar WHERE tanggal_dikeluarkan BETWEEN '2021-11-01' AND '2021-11-31'");
		$surat12 = mysql_query("SELECT * FROM surat_keluar WHERE tanggal_dikeluarkan BETWEEN '2021-12-01' AND '2021-12-31'");

		$surat13 = mysql_query("SELECT * FROM disposisi WHERE tanggal_disposisi BETWEEN '2021-07-01' AND '2021-07-31'");
		$surat14 = mysql_query("SELECT * FROM disposisi WHERE tanggal_disposisi BETWEEN '2021-08-01' AND '2021-08-30'");
		$surat15 = mysql_query("SELECT * FROM disposisi WHERE tanggal_disposisi BETWEEN '2021-09-01' AND '2021-09-31'");
		$surat16 = mysql_query("SELECT * FROM disposisi WHERE tanggal_disposisi BETWEEN '2021-10-01' AND '2021-10-30'");
		$surat17 = mysql_query("SELECT * FROM disposisi WHERE tanggal_disposisi BETWEEN '2021-11-01' AND '2021-11-31'");
		$surat18 = mysql_query("SELECT * FROM disposisi WHERE tanggal_disposisi BETWEEN '2021-12-01' AND '2021-12-31'");
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <h3 class="panel-title">Grafik Disposisi Surat 2021</h3>
                                            </div>
                                            <div class="panel-body">
                                                <div class="container">
